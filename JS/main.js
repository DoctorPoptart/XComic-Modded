...
const sites = [
	...
	},
	{
		name: 'multporn',
		url: 'multporn.net',
		home: 'multpornChangePage(1, false, true)',
		repair: 'multpornRepairComicInfoGetInfo({id}, {whitch})',
		repairAll: 'multpornRepairAllComicInfo({id}, {comic_id})',
		search: 'multpornSearch({text}, 1, false, true)',
		jump: 'multpornJumpPage({index}, {page})',
		downloader: 'multpornDownloader({id})'
	}
]
