class Tab {
	...
	Clicked(index, newTab = false) {
		...
		if (site == 0) {
			...
			switch(this.linksIndex[index]) {
				case 0:
					multpornOpenAllTags(newTab)
					break
				case 1:
					multpornOpenCategory(this.linksValue[index][0], this.linksValue[index][1], this.linksValue[index][2], newTab)
					break
				case 2:
					multpornOpenPost(newTab, this.linksValue[index])
					break
				case 3:
					multpornChangePage(this.linksValue[index], newTab)
					break
				case 4:
					multpornOpenTag(this.linksValue[index][0], this.linksValue[index][1], this.linksValue[index][2], newTab)
					break
				case 5:
					multpornSearch(this.linksValue[index][0], this.linksValue[index][1], newTab)
					break
			}
		}
	}
